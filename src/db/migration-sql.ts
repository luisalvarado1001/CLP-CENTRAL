// Generado automáticamente desde drizzle/0000_*.sql — NO editar a mano.
// DDL completo del esquema CLP. Se ejecuta desde /setup.

export const MIGRATION_SQL = `CREATE TYPE "public"."currency" AS ENUM('USD', 'PEN');--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "contabilidad_checklist" (
...
CREATE TABLE IF NOT EXISTS "cashflow_proyeccion" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tipo" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "importacion_costos" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "facturas_rh" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tipo" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "prestamos_tasas_historico" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"prestamo_id" uuid NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "optimizacion_alquileres" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"concepto" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "tanques_series" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"serie" text NOT NULL,
	"importacion_id" uuid,
	"lote" integer,
