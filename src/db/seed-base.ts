...
/** Carga la data inicial real de CLP (proveedores, importaciones, ventas, prestamos, alquileres). */
export async function seedBase(db: NeonHttpDatabase<Record<string, never>>) {
